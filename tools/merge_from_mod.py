...
def replace(target_file, field, newdata, original):
  ...
  if "Por" in data[index]["Texts"]:
    olddata = data[index]["Texts"]["Por"]
  if olddata == newdata or len(newdata) == 0:
    ...
    print("Old Portuguese text:")
    print('  "' + data[index]["Texts"]["Por"] + '"')
    print("New Portuguese text:")
    print("  \"" + newdata + '"')
